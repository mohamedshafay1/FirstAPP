...
import 'Screens/CountAzkar.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AnimatedSplashScreen(
        splash: Image.asset('assets/images/الله.jpg',fit: BoxFit.fitHeight,),
        nextScreen: HomeTab(),
        duration: 3000 ,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:AppBar(
          ...
          centerTitle: true,
          leading: const Icon(Icons.arrow_back_ios,color:Color.fromRGBO(59, 121, 55, 1),),
          actions: const [
            Icon(
              Icons.info_outline,
              color: Color.fromRGBO(59, 121, 55, 1),
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children:  [
          const Text(" سُبْحَانَ اللَّهِ",style: TextStyle(fontSize: 35),),
